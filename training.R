...
colnames(training.corr) <- c("SD2","RevUtilUnsecLines","age","#30-59","DebtRatio","MonthyIncome",
                         "#CreditLines&Loans","#90dayslate","#RealEstateLoans/lines","#60-89","#Dependents")
rownames(training.corr) <- c("SD2","RevUtilUnsecLines","age","#30-59","DebtRatio","MonthyIncome",
                         "#CreditLines&Loans","#90dayslate","#RealEstateLoans/lines","#60-89","#Dependents")
